            ...
            <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
              <div className='flex flex-col gap-2'>
                ...
                <Select.Root name='game'>
                  <Select.Trigger className='bg-zinc-900 py-3 px-4 rounded text-sm inline-flex items-center justify-between text-zinc-500'>
                  ...
                  <Select.Portal>
                    <Select.Content className='bg-zinc-900 py-3 px-3 rounded text-sm text-zinc-500'>
                      ...
                      <CaretUp className='w-6 h-6 text-zinc-400' />
                        ...
                        {games.map((game) => {
                          return (
                            <Select.Item key={game.id} value={game.id} className='leading-loose hover:bg-zinc-800 p-1 rounded flex items-center justify-between'>
